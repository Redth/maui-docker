Param([String]$DotnetVersion="9.0",
    ...
    [String]$DockerRepository="maui-containers/maui-gitea-runner-windows",
...
$buildPath = Join-Path -Path $PSScriptRoot -ChildPath "..\gitea-runner-build.ps1" -Resolve -ErrorAction SilentlyContinue
