...
# Start our emulator
android avd start --home="${ANDROID_HOME}" --name=Emulator_${ANDROID_SDK_API_LEVEL} --wait-boot --wait-exit --gpu="swiftshader_indirect" --accel="on" --wipe-data --no-window --no-audio --no-boot-anim
